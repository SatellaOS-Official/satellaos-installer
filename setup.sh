...
chmod +x "$HOME/satellaos-installer/SatellaOS/SatellaOS (Trixie).sh"
"$HOME/satellaos-installer/SatellaOS/SatellaOS (Trixie).sh"
...
chmod +x "$HOME/satellaos-installer/drivers/Touchpad.sh"
"$HOME/satellaos-installer/drivers/Touchpad.sh"

chmod +x "$HOME/satellaos-installer/drivers/Ekran Kartı Sürücüsü AMD.sh"
"$HOME/satellaos-installer/drivers/Ekran Kartı Sürücüsü.sh"

chmod +x "$HOME/satellaos-installer/drivers/Bluetooth Sürücüsü.sh"
"$HOME/satellaos-installer/drivers/Bluetooth Sürücüsü.sh"
